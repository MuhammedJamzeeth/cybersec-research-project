...
This directory should contain the trained ML models for the Password Security Assessment service.

## Required Files:

- `password_security_model.pkl` - Trained ML model for awareness prediction
- `password_security_scaler.pkl` - Feature scaler for input normalization
- `password_security_feature_names.pkl` - Feature names for the model
