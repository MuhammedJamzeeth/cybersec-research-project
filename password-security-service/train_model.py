"""
Train ML Model for Password Security Service
...
from src.utils.password_model_trainer import PasswordModelTrainer

def main():
    print("="*70)
    print("🚀 PASSWORD SECURITY MODEL TRAINING")
    print("="*70)
    
    # Define paths
    data_dir = project_root / 'data'
    dataset_path = data_dir / 'password.csv'
    answer_sheet_path = data_dir / 'answer_sheet_password.json'
