...
This directory should contain the trained ML models for the Device Security Assessment service.

## Required Files:

- `device_security_model.pkl` - Trained ML model for awareness prediction
- `device_security_scaler.pkl` - Feature scaler for input normalization
- `device_security_feature_names.pkl` - Feature names for the model
