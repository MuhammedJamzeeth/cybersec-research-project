...
This directory should contain the trained ML models for the Social Engineering Assessment service.

## Required Files:

- `social_engineering_model.pkl` - Trained ML model for awareness prediction
- `social_engineering_scaler.pkl` - Feature scaler for input normalization
- `social_engineering_feature_names.pkl` - Feature names for the model
