...
class ModelService:
    ...
    def _init_mongodb(self):
        ...
        try:
            ...
            self.assessments_collection = self.db['social_assessments']
    ...
    def get_explanation(self, question_id: str, option: str, user_profile: Dict) -> str:
        ...
        return f"Consider reviewing your understanding of social engineering tactics. Focus on recognizing manipulation techniques."
    
    def get_enhancement_advice(self, question_text: str, level: str) -> str:
        """Get enhancement advice based on performance level"""
        level_lower = level.lower()
        advice_map = {
            'wrong': 'Review the fundamentals of social engineering and manipulation tactics.',
            'beginner': 'Good start! Deepen your understanding of social engineering attacks.',
            'basic': 'Good start! Deepen your understanding of social engineering attacks.',
            'intermediate': 'Well done! Consider exploring advanced social engineering defenses.',
            'advanced': 'Excellent! Stay updated with latest social engineering techniques and countermeasures.'
        }
        return advice_map.get(level_lower, 'Continue learning about social engineering security.')
    ...
    def get_ml_based_recommendations(self, awareness_level: str, confidence: float, 
        ...
        if awareness_level == "Low Awareness":
            recommendations.append(
                "Your assessment indicates you need to strengthen your social engineering awareness. "
                "Start with understanding common manipulation tactics."
            )
            if education in ['O/L', 'A/L']:
                recommendations.append("Consider taking online courses on social engineering awareness.")
            else:
                recommendations.append("Review documentation on social engineering attacks and countermeasures.")
                
        elif awareness_level == "Moderate Awareness":
            recommendations.append(
                f"You have a moderate understanding (confidence: {confidence:.1%}). "
                "Focus on advanced social engineering defense techniques."
            )
            recommendations.append("Study psychological manipulation tactics and how to recognize them.")
            
        elif awareness_level == "High Awareness":
            recommendations.append(
                f"Excellent! Your awareness is high (confidence: {confidence:.1%}). "
                "Continue staying updated with latest social engineering trends."
            )
            recommendations.append("Explore advanced topics like deepfakes and AI-powered social engineering.")
