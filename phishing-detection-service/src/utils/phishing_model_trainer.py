...
class PhishingModelTrainer:
    ...
    def load_answer_sheet(self):
        ...
        print(f"✅ Loaded {len(self.questions)} phishing detection questions from answer sheet")
    ...
    def train_model(self):
        """Train the Logistic Regression model for phishing detection"""
        ...
        print(f"\n{'='*60}")
        print(f"Phishing Detection Model Accuracy: {accuracy:.2%}")
        print(f"{'='*60}")
        ...
        scaler_path = os.path.join(models_dir, 'phishing_scaler.pkl')
        features_path = os.path.join(models_dir, 'phishing_feature_names.pkl')
...
if __name__ == "__main__":
    ...
    dataset_path = os.path.join(project_root, 'phishing-detection-service', 'data', 'phishing_detection.csv')
    answer_sheet_path = os.path.join(project_root, 'phishing-detection-service', 'data', 'answer_sheet_phishing.json')
    
    trainer = PhishingModelTrainer(dataset_path, answer_sheet_path)
